...
def is_eligible_for_promotion(cutoff_age: int) -> Callable[[Customer], bool]:
    def is_eligible_age(customer: Customer) -> bool:
...
def main() -> None:
    ...
    send_email_promotion(customers, is_eligible_for_promotion(50))
